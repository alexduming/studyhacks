...
const InfographicClient = ({ editTaskId, editTaskData }: InfographicClientProps) => {
   ...
   */
  useEffect(() => {
    if (editTaskId && editTaskData) {
      loadEditTaskFromServerData(editTaskData);
    }
...
export default InfographicClient;
